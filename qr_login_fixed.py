...
class XiaohongshuQRLogin:
    ...
    async def login(self) -> bool:
        ...
        async with async_playwright() as p:
            ...
            await page.screenshot(path="/tmp/xhs_step3.png")

            if not qr_clicked:
                print("⚠️  自动点击扫码登录失败，请手动点击")
                print("\n💡 请在浏览器中点击'扫码登录'选项")
                input("看到二维码后按Enter继续...")

            await asyncio.sleep(2)
            await page.screenshot(path="/tmp/xhs_step4.png")
